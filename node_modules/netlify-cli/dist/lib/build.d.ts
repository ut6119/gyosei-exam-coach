import build, { type NetlifyConfig, type OnPostBuild, type Logs } from '@netlify/build';
...
export declare const getRunBuildOptions: ({ cachedConfig, currentDir, defaultConfig, deployHandler, deployId, options: { context, cwd, debug, dry, json, offline, silent }, packagePath, skewProtectionToken, token, }: {
    cachedConfig: CachedConfig;
    currentDir: string;
