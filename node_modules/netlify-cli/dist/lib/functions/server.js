...
export const startFunctionsServer = async (options) => {
    const { aiGatewayContext, blobsContext, capabilities, command, config, debug, generatedFunctions, loadDistFunctions, settings, site, siteInfo, siteUrl, timeouts, } = options;
